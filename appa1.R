...
server <- function(input, output) {
   ...
   output$hyperspectral_false_color <- renderPlot({
     extract_plot_grid_item(18,
                          image_spectrum_table = load_image(image_path = paste0("/scratch2/NSF_GWAS/macroPhor_Array/CT_CU_CV_raw/wk6/",
                                                                                filename),
                                                            FP = "DsRed"),
                          ...
                          max_intensity_Chl = 200,
                          scale = TRUE,
                          normalize = FALSE,
                          to_denoise = TRUE,
                          standardize_rgb = TRUE,
                          denoise_threshold_FP = 0,
                          denoise_threshold_Chl = 0,
                          dim_chlorophyll = 1,
                          FP = "DsRed")
   })
   ###################################################################################
