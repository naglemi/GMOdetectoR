...
crop_and_plot <- function(mode="whole_plate", grid_item, image_spectrum_table = image_spectrum_table_colored, image_type="hyperspectral",
  ...
  if(mode=="whole_plate" | mode=="both"){
    ...
    if (image_type=="CLS"){
      ...
      colnames(image_spectrum_table) <- c("cols", "rows", image_to_crop@wavelength)
    ...
    if (image_type=="CLS"){
      ...
      image_spectrum_table[image_spectrum_table < 0] <- 0
      a <- ggplot(data=image_spectrum_table)+
      ...
      b <- ggplot(data=image_spectrum_table)+
      ...
      c <- ggplot(data=image_spectrum_table)+
      ...
      d <- ggplot(data=image_spectrum_table)+
