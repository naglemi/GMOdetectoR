...
destination_path <- paste0("PhenotypeAssistant/EA/wk1/FPcap015_Chlcap25_denoiseChl05_denoiseFP004/")
phenotype_assistant_loop(folder_path_all_images = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1",
                         chroma_standard_path = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1/chroma_10.85_F2.2_L100_151635_0_0_0.raw",
                         FP_cap = 0.15,
                         Chl_cap = 2.5,
                         denoise_thr_Chl = 0.5,
                         denoise_thr_FP = 0.04,
...
destination_path <- paste0("PhenotypeAssistant/EA/wk1/FPcap015_Chlcap25_denoiseCh0_denoiseFP0/")
phenotype_assistant_loop(folder_path_all_images = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1",
                         chroma_standard_path = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1/chroma_10.85_F2.2_L100_151635_0_0_0.raw",
                         FP_cap = 0.15,
                         Chl_cap = 2.5,
...
destination_path <- paste0("PhenotypeAssistant/EA/wk1/FPcap010_Chlcap25_denoiseCh0_denoiseFP0/")
phenotype_assistant_loop(folder_path_all_images = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1",
                         chroma_standard_path = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1/chroma_10.85_F2.2_L100_151635_0_0_0.raw",
                         FP_cap = 0.10,
                         Chl_cap = 2.5,
...
destination_path <- paste0("PhenotypeAssistant/EA/wk1/FPcap075_Chlcap25_denoiseCh0_denoiseFP0/")
phenotype_assistant_loop(folder_path_all_images = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1",
                         chroma_standard_path = "/scratch2/NSF_GWAS/macroPhor_Array/T16_DEV_genes/EA/wk1/chroma_10.85_F2.2_L100_151635_0_0_0.raw",
                         FP_cap = 0.075,
                         Chl_cap = 2.5,
