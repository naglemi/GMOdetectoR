...
source("/scratch2/NSF_GWAS/GMOdetectoR/GMOdetectoRv0.18.R")

chroma_standard_path <- "/scratch2/NSF_GWAS/macroPhor_Array/CT_CU_CV_raw/wk6/chroma_F2.2_I0.85_L100_cyan_005537_0_0_0.raw"
...
phenotype_assistant(image_path = paste0("/scratch2/NSF_GWAS/macroPhor_Array/CT_CU_CV_raw/wk6/",
                                        filename),
